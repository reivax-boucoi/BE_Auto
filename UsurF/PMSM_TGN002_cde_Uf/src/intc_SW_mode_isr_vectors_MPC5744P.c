...
/*========================================================================*/
void dummy 						  (void);
extern void ERQ_SW1_isr(void);
extern void FMSTR_Isr(void);
extern void ADC0_EOC_FAST_LOOP_isr(void);
extern void ERQ_GD_INT_OCOUT_isr(void);
extern void ERQ_PGA411_Fault_isr(void);
...
(uint32_t) &ERQ_GD_INT_OCOUT_isr, /* Vector # 244 SIUL2 External Interrupt_1 SIUL2 */
(uint32_t) &ERQ_PGA411_Fault_isr, /* Vector # 245 SIUL2 External Interrupt_2 SIUL2 */
(uint32_t) &ERQ_SW1_isr, /* Vector # 246 SIUL2 External Interrupt_3 SIUL2 */
...
(uint32_t) &FMSTR_Isr, /* Vector # 380 LINFlex_RXI LINFlex_1 */
(uint32_t) &FMSTR_Isr, /* Vector # 381 LINFlex_TXI LINFlex_1 */
...
(uint32_t) &ADC0_EOC_FAST_LOOP_isr, /* Vector # 496 ADC_EOC ADC_0 */
